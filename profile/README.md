...
<h2 align="center">Scale up automated dev environments for each task, at the edge. ImagineDevOps continuously builds your project templates so that you can start coding right away - no more waiting for dependencies to download and builds to finish.</h2>
